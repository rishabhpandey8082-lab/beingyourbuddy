      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            {isLogin
              ? "Sign in to continue to YourBuddy"
              : "Join YourBuddy and start learning"}
          </p>
        </div>
        ...
        <p className="text-xs text-center text-muted-foreground mt-4">
          Note: Google sign-in requires backend configuration.
          <br />
          Use email sign-up for immediate access.
        </p>
      </motion.div>
    </div>
  );
